...
public class MainDesignOnly {
	...
	public ArrayList main_design(double nManning, int elevationChange, double minDepth, double maxDepth, int typeCost ) throws IOException{
			...
			Design_GraphBuilder design_builder = new Design_GraphBuilder(dh, nManning, typeCost, dh.precision);
