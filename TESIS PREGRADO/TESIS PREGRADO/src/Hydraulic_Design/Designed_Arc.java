...
public class Designed_Arc {
	...
	public Random_Layout regresion;
	...
	public String toString() {
		...
		print=(up.parental_loNode.myManhole.id+1)+" "+(down.parental_loNode.myManhole.id+1)+" "+up.parental_loNode.type+" "+" "+down.diameter+" "+up.elevation +" "+down.elevation;
		return print;
	}
}
