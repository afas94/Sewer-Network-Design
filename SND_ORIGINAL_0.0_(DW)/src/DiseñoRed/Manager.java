...
public class Manager {
	 ...
	 * @throws IOException
	 */
	public void designNetwork(int iter, double ks, int elevationChange, double minDepth, double maxDepth, int typeCost) throws IOException {
		Process child;
        File f = new File("XPRESS/TESISV5.mos");
        ...
        saveSolution(iter, mdo.main_design(ks, elevationChange, minDepth, maxDepth,  typeCost));
	}
	 ...
	 * @throws IOException
	 */
	public void initialize(int ini_iterations, double ks, int elevationChange, double minDepth, double maxDepth, int typeCost) throws IOException {
		...
		while (iteration<initialIterations){
			...
			designNetwork(iteration, ks, elevationChange, minDepth, maxDepth,typeCost);
...
//						System.out.println(myRegressions.get(createMyKey).getRSquare());
					...
					System.out.println("/Ini/" + iteration +  " costo: " + costo);
...
//		
	 ...
	 * @throws IOException
	 */
	public void execute(int iter,double ks, int elevationChange, double minDepth, double maxDepth, int typeCost) throws IOException {
...
//					System.out.println(myRegressions.get(createMyKey).getRSquare());
				...
				System.out.println("/Reg/" + iteration +  " costo: " + costo);
				r.add("El costo total: " + costo);
//				System.out.println(gnl_Regression.getIntercept()); r.add(""+gnl_Regression.getIntercept());
//				System.out.println(gnl_Regression.getSlope()); r.add(""+gnl_Regression.getSlope());
				System.out.println("Gnrl: "+gnl_Regression.getRSquare()); r.add(""+gnl_Regression.getRSquare());
